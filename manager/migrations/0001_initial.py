# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-03-15 18:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[(b'1', 'Beginner'), (b'2', 'Medium'), (b'3', 'Advanced')], help_text="Talk's Technical level", max_length=100, verbose_name='Level')),
                ...
                ('status', models.CharField(choices=[(b'1', 'Proposal'), (b'2', 'Accepted'), (b'3', 'Rejected')], help_text='Activity proposal status', max_length=20, verbose_name='Status')),
                ('image', image_cropping.fields.ImageCropField(blank=True, null=True, upload_to=b'images_thumbnails', verbose_name='Image')),
                ('cropping', image_cropping.fields.ImageRatioField(b'image', '700x450', adapt_rotation=False, allow_fullsize=False, free_crop=False, help_text='The image must be 700x450 px. You can crop it here.', hide_image_field=False, size_warning=True, verbose_name='Cropping')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('validate', models.CharField(choices=[(b'1', 'Validate URL'), (b'2', 'Validate Email'), (b'3', "Don't validate")], help_text='Type of field validation', max_length=10, verbose_name='Level')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='manager.Event', verbose_name=b'Event')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('level', models.CharField(choices=[(b'1', 'Beginner'), (b'2', 'Medium'), (b'3', 'Advanced'), (b'4', 'Super Hacker')], help_text='Knowledge level for an installation', max_length=200, verbose_name='Level')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='manager.Event', verbose_name=b'Event')),
            ],
            options={
                'ordering': ['name'],
                'verbose_name': 'Room',
        ...
        migrations.AddField(
            model_name='contact',
            name='event',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='contacts', to='manager.Event', verbose_name=b'Event'),
        ),
        migrations.AddField(
            model_name='contact',
            name='type',
