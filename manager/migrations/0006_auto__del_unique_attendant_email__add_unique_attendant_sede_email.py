...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Attendant', fields ['email']
        db.delete_unique(u'manager_attendant', ['email'])

        # Adding unique constraint on 'Attendant', fields ['sede', 'email']
        db.create_unique(u'manager_attendant', ['sede_id', 'email'])


    def backwards(self, orm):
        # Removing unique constraint on 'Attendant', fields ['sede', 'email']
        db.delete_unique(u'manager_attendant', ['sede_id', 'email'])

        # Adding unique constraint on 'Attendant', fields ['email']
        db.create_unique(u'manager_attendant', ['email'])
    ...
    models = {
        ...
        u'manager.attendant': {
            'Meta': {'unique_together': "(('email', 'sede'),)", 'object_name': 'Attendant'},
        ...
        u'manager.talkproposal': {
            ...
            'dummy_talk': ('django.db.models.fields.BooleanField', [], {}),
