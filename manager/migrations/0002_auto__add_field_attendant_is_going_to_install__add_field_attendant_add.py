...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attendant.is_going_to_install'
        db.add_column(u'manager_attendant', 'is_going_to_install',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Attendant.additional_info'
        db.add_column(u'manager_attendant', 'additional_info',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Attendant.is_going_to_install'
        db.delete_column(u'manager_attendant', 'is_going_to_install')

        # Deleting field 'Attendant.additional_info'
        db.delete_column(u'manager_attendant', 'additional_info')
