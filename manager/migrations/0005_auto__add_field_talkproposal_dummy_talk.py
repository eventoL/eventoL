...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TalkProposal.dummy_talk'
        db.add_column(u'manager_talkproposal', 'dummy_talk',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TalkProposal.dummy_talk'
        db.delete_column(u'manager_talkproposal', 'dummy_talk')
