...
urlpatterns = patterns('',
                       ...
                       url(r'^registration/success$', TemplateView.as_view(template_name='registration/success.html'),
                       ...
                       url(r'^registration/attendant/assisted$',
                           TemplateView.as_view(template_name='registration/attendant/assisted.html'),
                           name="attendant_assisted"),
                       url(r'^registration/attendant/by-collaborator$', views.attendant_registration_by_collaborator,
                           name='attendant_registration_by_collaborator'),
                       url(r'^installation$', views.installation, name='installation'),
                       url(r'^installation/success$', TemplateView.as_view(template_name='installation/success.html'),
                           name='installation_success'),
                       url(r'^talk/proposal/image-cropping/(?P<image_id>\d+)/$', views.image_cropping,
                           name='image_cropping'),
                       ...
                       url(r'^talk/confirm$', TemplateView.as_view(template_name='talks/confirm.html'),
                           name='talk_confirm'),
