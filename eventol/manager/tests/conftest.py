...
from .constants import EVENT_NAME_1
from .constants import EVENT_NAME_2
from .constants import EVENT_SLUG_1
from .constants import EVENT_SLUG_2
from .constants import EVENT_TAG_NAME_1
from .constants import EVENT_TAG_NAME_2
from .constants import EVENT_TAG_SLUG_1
from .constants import EVENT_TAG_SLUG_2
from .constants import USER_PASSWORD_1
from .constants import USER_PASSWORD_2
from .constants import USER_USERNAME_1
from .constants import USER_USERNAME_2
...
@pytest.mark.django_db
def event_tag_1():
    yield autofixture.create_one("manager.EventTag", {"name": EVENT_TAG_NAME_1, "slug": EVENT_TAG_SLUG_1})


@pytest.fixture
@pytest.mark.django_db
def event_tag_2():
    yield autofixture.create_one("manager.EventTag", {"name": EVENT_TAG_NAME_2, "slug": EVENT_TAG_SLUG_2})
...
def event1(event_tag_1):
    yield autofixture.create_one("manager.Event", {"name": EVENT_NAME_1, "slug": EVENT_SLUG_1, "tags": [event_tag_1]})


@pytest.fixture
@pytest.mark.django_db
def event2(event_tag_2):
    yield autofixture.create_one("manager.Event", {"name": EVENT_NAME_2, "slug": EVENT_SLUG_2, "tags": [event_tag_2]})
...
def attendee_from_event_user1(event_user1, event1):
    yield autofixture.create_one(
        "manager.Attendee",
        {"event_user": event_user1, "event": event1, "email_token": generate_ticket_code()},
    )
...
def attendee_from_event_user2(event_user2, event2):
    yield autofixture.create_one(
        "manager.Attendee",
        {"event_user": event_user2, "event": event2, "email_token": generate_ticket_code()},
    )
...
def event_data1(
    ...
    user1,
    event_user1,
    attendee_without_user1,
    attendee_from_event_user1,
    organizer1,
    collaborator1,
    installer1,
    reviewer1,
...
def event_data2(
    ...
    user2,
    event_user2,
    attendee_without_user2,
    attendee_from_event_user2,
    organizer2,
    collaborator2,
    installer2,
    reviewer2,
