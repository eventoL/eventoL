...
ALL_ADMIN_MODELS_URLS_NAMES = [url_name.format(model) for model in ADMIN_MODELS for url_name in ADMIN_URL_NAMES]

ALL_ADMIN_URLS_NAMES = ADMIN_DEFAULT_URL_NAMES + ALL_ADMIN_MODELS_URLS_NAMES + ADMIN_URL_NAMES_FOR_APPS
...
# Accounts
ACCOUNTS_URL_NAMES = ["account_login", "account_logout", "user_profile", "account_signup"]
...
API_URL_NAMES = [f"{model}-list" for model in API_MODELS]
ALL_API_URL_NAMES = [API_BASE_URL_NAME] + API_URL_NAMES

API_URLS_REQUIRED_FROM_INDEX_PAGE = [
    (
        "event-list",
        "my_events=true&fields=event_slug,place,image,name,attendees_count,abstract,tags",
    ),
    (
        "event-list",
        "ordering=-created_at&registration_is_open=true&fields=event_slug,place,image,name,attendees_count,abstract,tags",
    ),
    (
        "event-list",
        "ordering=-attendees_count&registration_is_open=true&fields=event_slug,place,image,name,attendees_count,abstract,tags",
    ),
    (
        "event-list",
        "registration_is_open=true&ordering=last_date&fields=event_slug,place,image,name,attendees_count,abstract,tags",
    ),
    (
        "event-list",
        "schedule_confirmed=true&registration_is_open=true&fields=event_slug,place,image,name,attendees_count,abstract,tags",
    ),
    (
        "event-list",
        "registration_is_open=false&ordering=-attendees_count&fields=event_slug,place,image,name,attendees_count,abstract,tags",
    ),
]
API_URLS_REQUIRED_FROM_EVENT_INDEX_PAGE = [
    (
        "event-list",
        "my_events=true&fields=event_slug,place,image,name,attendees_count,abstract,tags&tags__slug=qwertyui",
    ),
    (
        "event-list",
        "registration_is_open=true&ordering=last_date&fields=event_slug,place,image,name,attendees_count,abstract,tags&tags__slug=qwertyui",
    ),
    (
        "event-list",
        "registration_is_open=false&ordering=-attendees_count&fields=event_slug,place,image,name,attendees_count,abstract,tags&tags__slug=qwertyui",
    ),
    (
        "event-list",
        "limit=15&offset=0&fields=name,event_slug,email,location,report,id,tags&ordering=name",
    ),
...
ALL_API_URLS_REQUIRED_FROM_PAGE = API_URLS_REQUIRED_FROM_INDEX_PAGE + API_URLS_REQUIRED_FROM_EVENT_INDEX_PAGE + API_URLS_REQUIRED_FROM_REPORT_PAGE
...
EVENT_URLS_DATA = [
    ...
    (
        "edit_activity_proposal",
        "manager.views.edit_activity_proposal",
    ...
    (
        ...
        "manager.views.attendee_confirm_email",
        ["event_slug", "attendee_id", "token"],
    ),
    ...
    (
        "attendee_registration_by_collaborator",
        "manager.views.registration_by_collaborator",
        ["event_slug"],
    ),
    (
        "attendee_registration_by_self",
        "manager.views.attendee_registration_by_self",
        ["event_slug", "event_registration_code"],
    ),
    ...
    (
        "attendee_registration_from_installation",
        "manager.views.registration_from_installation",
        ["event_slug"],
    ),
    ...
    (
        "attendee_registration_print_code",
        "manager.views.attendee_registration_print_code",
        ["event_slug"],
    ),
...
ALL_URL_NAMES = ACCOUNTS_URL_NAMES + AUTOCOMPLETE_URL_NAMES + ALL_ADMIN_URLS_NAMES + ALL_API_URL_NAMES + EVENT_URL_NAMES
