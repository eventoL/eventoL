...
event_patterns = [
    ...
    re_path(
        r'^registration/attendee/search/(?P<ticket_code>\w+)$', views.attendance_by_ticket, name='attendance_by_ticket'
    ),
    ...
    re_path(
        r'^registration/attendee/by-self/(?P<event_registration_code>'
    ...
    re_path(
        r'^registration/attendee/by-self/autoreadqr', views.attendance_by_autoreadqr, name='attendance_by_autoreadqr'
    ),
    re_path(
        r'^registration/print-code$', views.attendee_registration_print_code, name='attendee_registration_print_code'
    ),
    re_path(r'^registration/collaborator$', views.collaborator_registration, name='collaborator_registration'),
    ...
    re_path(
        r'^activity/proposal/(?P<activity_id>\d+)/edit/$', views.edit_activity_proposal, name='edit_activity_proposal'
    ),
    re_path(r'^activity/proposal/image-cropping/(?P<activity_id>\d+)/$', views.image_cropping, name='image_cropping'),
    re_path(r'^activity/proposal/image-cropping/$', views.image_cropping, name='image_cropping'),
    re_path(r'^activity/registration/(?P<proposal_id>\d+)$', views.talk_registration, name='talk_registration'),
    ...
    re_path(r'^activity/reject_activity/(?P<activity_id>\d+)/$', views.reject_activity, name='reject_activity'),
    re_path(r'^activity/resend_proposal/(?P<activity_id>\d+)/$', views.resend_proposal, name='resend_proposal'),
    re_path(r'^activity/(?P<activity_id>\d+)/vote/up$', views.activity_vote_up, name='activity_vote_up'),
    re_path(r'^activity/(?P<activity_id>\d+)/vote/down$', views.activity_vote_down, name='activity_vote_down'),
    re_path(r'^activity/(?P<activity_id>\d+)/vote/cancel$', views.activity_vote_cancel, name='activity_vote_cancel'),
    ...
    re_path(
        r'^animalistos$',
        TemplateView.as_view(template_name='event/index_animalistos_puntocoop.html'),
        name='attendee_email_sent',
    ),
]
