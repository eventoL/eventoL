...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='activity',
            name='owner',
            field=models.ForeignKey(help_text='Speaker or the person in charge of the activity', null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL),
        ),
        ...
        migrations.AlterField(
            model_name='activity',
            name='owner',
            field=models.ForeignKey(help_text='Speaker or the person in charge of the activity', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL),
        ),
    ]
