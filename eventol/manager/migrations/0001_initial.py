    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.CharField(blank=True, max_length=50, null=True, verbose_name="Type"),
                ),
                (
                    "speakers_names",
                    models.CharField(
                        help_text="Comma separated speaker's names",
                        max_length=600,
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("1", "Proposal"), ("2", "Accepted"), ("3", "Rejected")],
                ...
                (
                    ...
                    image_cropping.fields.ImageCropField(
                        blank=True, null=True, upload_to="images_thumbnails", verbose_name="Image"
                    ),
                ),
                (
                    "cropping",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_installing",
                    models.BooleanField(default=False, verbose_name="Is going to install?"),
                ),
                (
                    "additional_info",
                    models.CharField(
                ...
                (
                    "email_token",
                    models.CharField(
                        blank=True, max_length=200, null=True, verbose_name="Confirmation Token"
                    ),
                ),
                (
                    "registration_date",
                    models.DateTimeField(blank=True, null=True, verbose_name="Registration Date"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "phone",
                    models.CharField(blank=True, max_length=200, null=True, verbose_name="Phone"),
                ),
                (
                    "address",
                    models.CharField(blank=True, max_length=200, null=True, verbose_name="Address"),
                ),
                (
                    "additional_info",
                    models.CharField(
                        blank=True,
                        help_text="Any additional info you consider relevant",
                        max_length=200,
                        null=True,
                        verbose_name="Additional Info",
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "text",
                    models.CharField(help_text="i.e. @Flisol", max_length=200, verbose_name="Text"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "abstract",
                    models.TextField(
                        help_text="Short idea of the event (One or two sentences)",
                        max_length=250,
                        verbose_name="Abstract",
                    ),
                ),
                ...
                (
                    ...
                    ckeditor.fields.RichTextField(
                        blank=True,
                        help_text="Event Information HTML",
                        null=True,
                ...
                (
                    "schedule_confirmed",
                    models.BooleanField(default=False, verbose_name="Schedule Confirmed"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date",
                    models.DateField(help_text="When will your event be?", verbose_name="Date"),
                ),
                (
                    "event",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "manufacturer",
                    models.CharField(
                        blank=True, max_length=200, null=True, verbose_name="Manufacturer"
                    ),
                ),
                (
                    "model",
                    models.CharField(blank=True, max_length=200, null=True, verbose_name="Model"),
                ),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    ckeditor.fields.RichTextField(
                        blank=True,
                        help_text="Email message HTML Body",
                        null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="i.e. Classroom 256", max_length=200, verbose_name="Name"
                    ),
                ),
                (
                    "event",
