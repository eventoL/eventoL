...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='event',
            name='event_slug',
            field=models.SlugField(help_text='For example: flisol-caba', max_length=100, unique=True, verbose_name='URL', null=True),
        ),
        ...
        migrations.AlterField(
            model_name='event',
            name='event_slug',
            field=models.SlugField(help_text='For example: flisol-caba', max_length=100, unique=True, verbose_name='URL'),
