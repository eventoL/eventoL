...
class Staging(Base):
    ...
    SECRET_KEY = os.getenv("SECRET_KEY", "!a44%)(r2!1wp89@ds(tqzpo#f0qgfxomik)a$16v5v@b%)ecu")
    ...
    RAVEN_CONFIG = {"dsn": os.environ.get("SENTRY_DSN", "NOT_CONFIGURED")}
    ...
    # CSRF
    CSRF_TRUSTED_ORIGINS = [f"http://{os.getenv('APP_DNS')}", f"https://{os.getenv('APP_DNS')}"]
